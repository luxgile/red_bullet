...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/bullet.aseprite", "start": 0, "end": 694}, {"filename": "/assets/bullet.png", "start": 694, "end": 1105}, {"filename": "/assets/floor.aseprite", "start": 1105, "end": 1508}, {"filename": "/assets/floor.png", "start": 1508, "end": 1746}, {"filename": "/assets/gun.aseprite", "start": 1746, "end": 2237}, {"filename": "/assets/gun.png", "start": 2237, "end": 2479}, {"filename": "/assets/gun_pickup.aseprite", "start": 2479, "end": 2949}, {"filename": "/assets/gun_pickup.png", "start": 2949, "end": 3288}, {"filename": "/assets/player.aseprite", "start": 3288, "end": 8644}, {"filename": "/assets/player.png", "start": 8644, "end": 10358}], "remote_package_size": 10358});

  })();

// end include: /tmp/tmpc62kzsme.js
// include: /tmp/tmpzr8gpqtv.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpzr8gpqtv.js
// include: /tmp/tmpvdzlmo7x.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpvdzlmo7x.js
...
var ASM_CONSTS = {
 ...
 144546: () => { return parseInt(document.getElementById('canvas').style.width); },  
 144614: () => { document.exitFullscreen(); },  
 144641: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 144714: () => { if (document.fullscreenElement) return 1; },  
 144760: () => { return document.getElementById('canvas').width; },  
 144812: () => { return screen.width; },  
 144837: () => { document.exitFullscreen(); },  
 144864: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 144997: () => { return window.innerWidth; },  
 145023: () => { return window.innerHeight; },  
 145050: () => { if (document.fullscreenElement) return 1; },  
 145096: () => { return document.getElementById('canvas').width; },  
 145148: () => { return parseInt(document.getElementById('canvas').style.width); },  
 145216: () => { if (document.fullscreenElement) return 1; },  
 145262: () => { return document.getElementById('canvas').width; },  
 145314: () => { return screen.width; },  
 145339: () => { return window.innerWidth; },  
 145365: () => { return window.innerHeight; },  
 145392: () => { if (document.fullscreenElement) return 1; },  
 145438: () => { return document.getElementById('canvas').width; },  
 145490: () => { return screen.width; },  
 145515: () => { document.exitFullscreen(); },  
 145542: () => { if (document.fullscreenElement) return 1; },  
 145588: () => { return document.getElementById('canvas').width; },  
 145640: () => { return parseInt(document.getElementById('canvas').style.width); },  
 145708: () => { document.exitFullscreen(); },  
 145735: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 145793: () => { return screen.width; },  
 145818: () => { return screen.height; },  
 145844: () => { return window.screenX; },  
 145871: () => { return window.screenY; },  
 145898: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 145951: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 146022: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 146079: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 146335: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 146406: () => { if (document.fullscreenElement) return 1; },  
 146452: () => { return window.innerWidth; },  
 146478: () => { return window.innerHeight; },  
 146505: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
